const cakeProduct = [
    {
        ...
        "price": "$55.00",
        "image": "images/cakes_images/blue_raspberry_cake.jpg"
    },
    {
        "productId": 2,
        ...
        "price": "$65.00",
        "image": "images/cakes_images/blueberry_cheesecake_sm.jpg"
    },
    {
        "productId": 3,
        ...
        "price": "$70.00",
        "image": "images/cakes_images/cake_burnout_candles_sm.jpg"
    },
    {
        "productId": 4,
        ...
        "description": "Sandwiched between 2 Strawberry red coloured large macaron shells are Fresh Strawberries Cream and our Signature Chocolate Ganache filling.",
        "price": "$49.00",
        "image": "images/cakes_images/mint_strawberry_lg.jpg"
    },
    {
        "productId": 5,
        ...
        "price": "$69.90",
        "image": "images/cakes_images/small_heritage_chocolate_cake.jpg"
    },
    {
        "productId": 6,
        ...
        "price": "$69.95",
        "image": "images/cakes_images/macaron_cake.jpg"
    },
    {
        "productId": 7,
        ...
        "price": "$50.00",
        "image": "images/cakes_images/xmas_redberry_cake.jpg"
    },
    {
        "productId": 8,
        ...
        "price": "$55.00",
        "image": "images/cakes_images/xmas_chocolate_cake.jpg"
    },
    {
        "productId": 9,
        ...
        "price": "$55.00",
        "image": "images/cakes_images/gingerbread_cake.jpg"
    },
    {
        "productId": 10,
        ...
        "price": "$69.95",
        "image": "images/cakes_images/sparkles_cake.jpg"
    }
];
...
${cakeProduct.map(function(cake) {
    ...
    <div class="indi-product">
        <div class="product-hvr">
            <div class="product">
                <img class="product-img" src= ${cake.image}>
            </div>
            <div class="details">
                <div class="content">
...
//        console.log(response.cakeProduct);
//     }
// };
// xhttp.open("GET", "json/cakes_testing.json", true);
// xhttp.send();

// fetch("json/cakes_testing.json")
//     .then(response => response.json())
//     .then(data =>{
//         console.log(data);
//         document.querySelector("#cakes").innerText = data
//     })